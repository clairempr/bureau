...
class PartialDateTestCase(TestCase):
    ...
    def test_partial_date(self):
        self.assertEqual(partial_date('1830'), '1830',
                         'partial_date() should return formatted year if only year present')
        self.assertEqual(partial_date(PartialDate('1830-11')), 'Nov. 1830',
                         'partial_date() should return formatted year and month if only those present')
        self.assertEqual(partial_date(PartialDate('1830-11-08')), 'Nov. 08, 1830',
                         'partial_date() should return formatted year, month, and day if all 3 present')
