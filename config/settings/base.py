...
ROOT_DIR = environ.Path(__file__) - 3  # (bureau/config/settings/base.py - 3 = bureau/)
APPS_DIR = ROOT_DIR.path('bureau')
...
# ------------------------------------------------------------------------------
# Django Admin URL.
ADMIN_URL = 'commissioner/'
# https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = [
    ("""Claire Pritchard""", 'claire-pritchard@example.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'bureau.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
CITIES_LIGHT_INCLUDE_CITY_TYPES = ['ADM1', 'INSM', 'PPL', 'PPLA', 'PPLA2', 'PPLA3', 'PPLA4', 'PPLC', 'PPLCH', 'PPLF',
